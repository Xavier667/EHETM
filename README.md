...
| **EFTSim** | TPAMI extension | Event streams + Voxel + IMU ego-motion measurements | [Baidu Netdisk](https://pan.baidu.com/s/13PJQvqvrpXGazzKg1A0Jag?pwd=qaz3) (code: `qaz3`) |
| **CTTH+** | TPAMI extension | Event streams + Voxel + IMU ego-motion measurements | [Baidu Netdisk](https://pan.baidu.com/s/1wdBz4eoLkBMFxZ2y4hBjJg?pwd=qaz3) (code: `qaz3`) |
